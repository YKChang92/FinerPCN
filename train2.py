...
def train(args):
    ...
    alpha =  tf.train.piecewise_constant(global_step, [20000, 40000, 100000], [0.01, 0.1, 0.5, 1.0], 'alpha_op')
...
if __name__ == '__main__':
    ...
    parser.add_argument('--lmdb_train', default='/media/hp2/F2EEF48AEEF447FD/BaiduNetdiskDownload/train.lmdb')
    parser.add_argument('--lmdb_valid', default='/media/hp2/F2EEF48AEEF447FD/BaiduNetdiskDownload/valid.lmdb')
    parser.add_argument('--log_dir', default='log/fpcn_4096')
    parser.add_argument('--model_type', default='fpcn_emd_4096')
